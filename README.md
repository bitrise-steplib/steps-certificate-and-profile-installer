...
| `keychain_path` | Path to the Keychain. | required | `$HOME/Library/Keychains/login.keychain` |
| `keychain_password` | Password of the Keychain. | required, sensitive | `$BITRISE_KEYCHAIN_PASSWORD` |
